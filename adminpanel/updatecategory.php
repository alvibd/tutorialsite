...
<body>
  ...
  <div class="container">
    <table class="responsive-table hoverable bordered">
      ...
      <tbody>
        <tr>
        <?php foreach ($data['allcats'] as $value) {?>
        <td><?php echo $i; ?></td>
        <td>
          <?php echo '<a href="editcategory.php?id='.$value["category_id"].'">'.$value["category_name"].'</a>'; ?>
        </td>
        <td><?php echo '<a href="editcategory.php?id='.$value["category_id"].'">Edit</a>'; ?></td>
        <td><?php echo '<a href="deletecategory.php?id='.$value["category_id"].'">Delete</a>'; ?></td>
        </tr>
        <?php $i++;
        } ?>
      </tbody>
